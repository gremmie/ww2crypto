  ...
  return (
    <Paper elevation={2} sx={{ mt: 3, ml: 3, p: 3, maxWidth: 950 }}>
      ...
      <Typography gutterBottom>
        Hello! This website was created by Brian Neal, a software developer from
        Des Moines, Iowa, USA.
      </Typography>
      <Typography gutterBottom>
        In the Spring of 2012 I discovered Dirk Rijmenants' Enigma Challenge at
        his website <ExternalLink id="cipher-machines" />. I was hooked! In 2012
        and 2013 I created Python libraries to simulate Enigma, the M-209, and
        PURPLE (see the <RouterLink to="/links">Links page</RouterLink>). I
        always wanted to create browser-based simulations of these machines, but
        I never seemed to have the time and my interests drifted elsewhere.
      </Typography>
      <Typography gutterBottom>
      ...
      <Typography gutterBottom>
        I would love to hear your questions, feedback, suggestions, bug reports,
        etc. You can reach me at{" "}
        <ExternalLink
