...
with React, Redux and MUI components.

The cipher machine simulations are based on the Python versions I created a while back:

- [Py-Enimga](https://github.com/gremmie/enigma) - Enigma machine (Germany)
